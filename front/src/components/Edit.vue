  ...
  <div class="frame"> 
    ...
    <div id='form'>
      <table>
        ...
        <tbody>
          <tr>
            <td><input type='text' name='goods-name' ref='goodsName' v-model="n" required/></td>
            <td><input type='number' name='goods-price' ref='goodsPrice' @keyup='calculation' v-model="p" required/></td>
            <td><input type='number' name='goods-quantity' ref='goodsQuantity' @keyup='calculation' v-model="q" required/></td>
          </tr>
        </tbody>
      </table>
...
export default {
  ...
  mounted(){
    axios({
      ...
      this.n = response.data['name'];
      this.p = response.data['price'];
      this.q = response.data['quantity'];
      this.v = response.data['total'];
    })
    .catch((error) => {
      console.log(error);
    })
